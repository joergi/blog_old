...
<p><img class="alignnone size-full wp-image-474" src="https://joergi77.files.wordpress.com/2020/03/github2.png" alt="github2" width="947" height="60" /></p>
<p>P.S. if you followed the tutorial, and something went wrong, it will look like this:</p><p><img class="alignnone size-full wp-image-473" src="https://joergi77.files.wordpress.com/2020/03/github3_fail.png" alt="github3_fail" width="947" height="60" /></p>
<p>But let's start from the beginning!<br /><br /><strong>First of all: Github gives you a great Readme for this, that's why I link it here were needed.</strong></p>
